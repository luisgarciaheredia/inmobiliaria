        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m12 l6 title-wrapper">
                    <h5 class="blue-text text-darken-4">Listado de Roles</h5>
                </div>
                <div class="col s12 m12 l6 buttons-wrapper">
                    <a class="waves-effect btn red" href="../../admin/role/create"><i class="material-icons left">add</i>Añadir Rol</a>
                </div>
            </div>
            ...
            <div class="overflow-x-auto card table-card" style='display:none'>
                <table class="hover row-border order-column centered compact" style="width:100%">
                    <thead>
                        <tr>
                            <th>Código</th>
                            <th>Rol</th>
