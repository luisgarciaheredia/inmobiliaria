        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 title-wrapper">
                    <h5 class="blue-text text-darken-4">Formulario Proyecto</h5>
                </div>
            </div>
                ...
                <form>
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="project" type="text" class="validate" required>
                            <label class="grey-text" for="project">Proyecto</label>
                        </div>
                        <div class="input-field col s12 ">
                            <div class="switch">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <a href="../../admin/project/list" class="waves-effect waves-light btn grey" type="button"><i class="material-icons left">cancel</i>Cancelar</a>
